...
void CRealtimezoomscrollDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Control(pDX, IDC_PIE_CHART, pie_ChartView);
	DDX_Control(pDX, IDC_HISTOGRAM, histogram_ChartView);
}
...
BOOL CRealtimezoomscrollDlg::OnInitDialog()
{
	...
	// intialize processing part
	//draw_histogramChart(&histogram_ChartView);
	//draw_pieChart(&pie_ChartView);
...
void CRealtimezoomscrollDlg::draw_pieChart(CChartViewer* viewer)
{
	...
	const char* labels[] = { "Sensor1", "Sensor2", "Sensor2", "Sensor2", "Sensor2", "Sensor2",
		"Sensor2" };

	// Create a PieChart object of size 360 x 300 pixels
	PieChart* a = new PieChart(360, 350);

	// Set the center of the pie at (180, 140) and the radius to 100 pixels
	a->setPieSize(180, 160, 120);

	// Add a title to the pie chart
	a->addTitle("Average value of pressure");

	// Draw the pie in 3D
	a->set3D();

	// Set the pie data and the pie labels
	a->setData(DoubleArray(data, (int)(sizeof(data) / sizeof(data[0]))), StringArray(labels, (int)(
	...
	viewer->setChart(a);  //pie_ChartView에 Chart를 보여주기 위한 코드

	delete a;
}


void CRealtimezoomscrollDlg::draw_histogramChart(CChartViewer* viewer)
{
	...
	BarLayer* histogramLayer = b->addBarLayer(DoubleArray(frequency, slotCount), 0x6699bb);
	...
	b->xAxis()->setIndent(false);
	b->addLineLayer()->setXData(minX, maxX);

	// For the automatic y-axis labels, set the minimum spacing to 40 pixels.
	b->yAxis()->setTickDensity(40);

	// Output the chart
	viewer->setChart(b);  //pie_ChartView에 Chart를 보여주기 위한 코드
